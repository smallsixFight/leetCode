...
### 最后
在写 `基本计算器 I` 总结整理的时候，发生了官方在我做完题的第二天补充了测试案例，改了官方题解，导致之前可以通过的解法发生了错误，于是又根据新的测试案例重新思考并修正解法。

另外，这周的状态不太好，不只是工作变忙碌后大脑不够用了，再加上热气牙疼，还是这周的题目难度上去了，导致这周的心态有些炸裂，做题的思路不够通顺，所以这周的思路和整理都写的偏多一些，下周尽量调整回来。